...
(
    ...
    title  VARCHAR(120) NOT NULL
        CONSTRAINT unique_title UNIQUE
);
...
(
    ...
    event_id  BIGINT         NOT NULL
        CONSTRAINT fk_comments_events REFERENCES events ON DELETE CASCADE ON UPDATE CASCADE,
    author_id BIGINT         NOT NULL
        CONSTRAINT fk_comments_users REFERENCES users ON DELETE CASCADE ON UPDATE CASCADE,
    created   TIMESTAMP      NOT NULL
);
